...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="row flex-center position-relative ">
            <div class="col-xxl-9">
                            ...
                            <div class="col-12">
                                <form method="post" name="requestForm" id="requestForm" action="{{route('roles.update', $role->id)}}">
                                    ...
                                    <div class="auth-form-box-2">
                                                    ...
                                                    <div class="row mt-2 mb-3">
                                                        @foreach($permissions as $index => $permission)
                                                            <div class="col-md-6 col-lg-4 col-sm-12">
                                                                <div class="form-check">
                                                                    <input class="form-check-input individual-checkbox" id="permissions_{{$index}}" name="permissions[]" type="checkbox" value="{{ $permission->id }}" {{ in_array($permission->id, $rolePermissions) ? "checked" : "" }} />
                                        ...
                                        <button type="submit" class="btn btn-info float-end my-4 mx-2"><span class="fas fa-download"></span> Update Data</button>
                                    </div>
                                </form>
                            </div>
                        </div>
